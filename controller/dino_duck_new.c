...
#define REPLAY_OFFSET    (19 * 4)   // reg19: replay trigger
...
int main(void) {
    ...
    while (1) {
        ...
        bool start_pressed = (report[6] == 0x20);  // Confirmed: Start = 0x20 in report[6]

        // Handle replay
        *replay_reg = start_pressed ? 1 : 0;
